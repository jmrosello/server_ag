...
def main() -> None:
    ...
    for rel, reason, action in [
        ...
        (
            "prode.old",
            "Carpeta antigua junto a prode protegido.",
            "Comparar contra prode activo y archivar si no esta ruteada.",
        ),
    ...
    for rel, site, reason in [
        ...
        ("ml", "assets externos", "Asset store intocable usado por otra app."),
        ("downloads", "hosting", "Carpeta intocable por decision operativa."),
        ("webmail", "hosting", "Carpeta intocable por decision operativa."),
